...
export default function CraftScreen() {
      ...
      <SafeAreaView style={styles.root} edges={['top']}>
        <View style={styles.center}>
          ...
          <Text style={styles.empty}>
            Pick a city to see what to taste, drink, and try.
          </Text>
        </View>
      </SafeAreaView>
    );
  ...
  if (!content || content.craftPages.length === 0) {
    return (
      <SafeAreaView style={styles.root} edges={['top']}>
        ...
        <LoadingState message={`Cooking up the ${city.name} guide…`} />
      </SafeAreaView>
    );
  }
  ...
  return (
    <SafeAreaView style={styles.root} edges={['top']}>
      <View style={styles.header}>
        <Text style={styles.title}>Craft</Text>
        <Text style={styles.subtitle}>What to taste in {city.name}</Text>
      </View>
      <ContentPager pages={content.craftPages} fallbackAccent={colors.craft} />
    </SafeAreaView>
  );
}
